        ...
        <div className="portfolio-hero-container">
          ...
          <div className="portfolio-hero-text-content">
            <h1 className="portfolio-hero-title">
              HI, I AM <br />
              <span className="portfolio-hero-name">ROBERT GARCIA.</span>
            </h1>
            <div className="portfolio-hero-subtitle">
              A Sydney based front-end developer passionate about building
              accessible and user friendly websites.
            </div>

            <div className="portfolio-hero-cta-group">
              <button className="portfolio-contact-pill">
                CONTACT ME <span className="portfolio-pill-dot"></span>
              </button>
          ...
          <div className="portfolio-hero-image-box">
            <img
              src="/boy.jpg"
              alt="Robert Garcia"
              className="portfolio-main-profile-img"
            />
          </div>
        </div>
      </section>
